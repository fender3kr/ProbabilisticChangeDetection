...
int main(int argc, char *argv[]) {
	...
	#pragma omp parallel for schedule(dynamic, grids / NUMBER_THREADS) shared(stderr, grids, plan, image_t1, image_t2, klds) private(grid_t1, grid_t2, gaussian_t1, gaussian_t2) num_threads(NUMBER_THREADS)
